...
public class ImageSelectActivity extends AppCompatActivity {
    ...
    public static TextView textViewCamera;
    public static TextView textViewGallery;
    ...
    public static boolean click_type_camera = false, click_type_gellery = false;
        ...
        textViewCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkPermission()) {
                    ...
                    click_type_camera = true;
                    click_type_gellery = false;
                } else {
        ...
        textViewGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkPermission()) {
                    ...
                    click_type_camera = false;
                    click_type_gellery = true;
                } else {
                    requestStoragePermission();
                    click_type_camera = false;
                    click_type_gellery = true;
